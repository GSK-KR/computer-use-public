...
echo.
del /q "%~dp02_백업_화면.url" "%~dp0백업 화면.url" "%~dp0Computer-Use-Web.url" "%~dp02_1_위챗_백업.url" "%~dp02_2_카카오톡_백업.url" "%~dp02_3_위챗_통째백업.url" "%~dp02_4_카카오톡_통째백업.url" >nul 2>nul
if not exist "%~dp0scripts\백업_화면_실행.bat" (
